...
def news_category(request):
    ...
    return render(request,'cms/news_caregory.html',context=context)

@require_POST
@permission_required(perm="news.add_newscategory",login_url='index')
...
@require_POST
@permission_required(perm="news.change_newscategory",login_url='index')
...
@require_POST
@permission_required(perm="news.delete_newscategory",login_url='index')
...
@permission_required(perm="news.add_banner",login_url='index')
def banners(request):
...
@permission_required(perm="news.delete_banner",login_url='index')
def delete_banner(request):
    banner_id = request.POST.get('banner_id');
    Banner.objects.filter(pk=banner_id).delete()
    return restful.ok()

@permission_required(perm="news.change_banner",login_url='index')
def edit_banner(request):
    ...
    if form.is_valid():
        ...
        return restful.result(message=form.get_errors())
