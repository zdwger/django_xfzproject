...
from . import views
from . import course_view,staff_views
...
urlpatterns = [
    ...
    path('edit_news/', views.EditNewsView.as_view(), name='write_news'),
    path('delete_news/', views.delete_news, name='delete_news'),
    path('add_news/', views.EditNewsView.as_view(), name='add_news'),
...
urlpatterns += [
    ...
    path('add_staffs',staff_views.AddStaffView.as_view(),name='add_staff'),
]
